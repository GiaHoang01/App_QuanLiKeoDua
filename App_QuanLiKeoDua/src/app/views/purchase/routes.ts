...
export const routes: Routes = [
  {
    ...
    data: { title: 'Yêu cầu nhập hàng', requiredPermission: 'Xem tài khoản' },
  ...
  },
  {
    ...
    data: { title: 'Cập nhật phiếu yêu cầu nhập hàng', requiredPermission: 'Xem tài khoản' },
    canActivate: [PermissionGuard],
  },
  {
    path: 'purchaseOrder',
    ...
    data: { title: 'Phiếu nhập hàng', requiredPermission: 'Xem tài khoản' },
    canActivate: [PermissionGuard],
  },
  {
