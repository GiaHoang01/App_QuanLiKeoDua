...
export const routes: Routes = [
  {
    ...
    data: { title: 'Yêu cầu nhập hàng', requiredPermission: 'VIEW_SALE_ORDER1' },
  ...
  },
  {
    ...
    data: { title: 'Cập nhật phiếu yêu cầu nhập hàng', requiredPermission: 'VIEW_SALE_ORDER' },
    canActivate: [PermissionGuard],
  },
  {
    path: 'purchaseOrder',
    ...
    data: { title: 'Phiếu nhập hàng', requiredPermission: 'VIEW_SALE_ORDER' },
    canActivate: [PermissionGuard],
  },
  {
  ...
  },
  {
    ...
    data: { title: 'Xác nhận phiếu nhập', requiredPermission: 'VIEW_SALE_ORDER' },
    canActivate: [PermissionGuard],
  },
];
