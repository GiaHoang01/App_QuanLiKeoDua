...
export const routes: Routes = [
  {
    ...
    data: {title: 'Đơn đặt hàng' ,requiredPermission: 'Xem hóa đơn'},
  ...
  },
  {
    ...
    data: {title: 'Duyệt đơn hàng' ,requiredPermission: 'Xem hóa đơn'},
    canActivate: [PermissionGuard],
  },
  {
    ...
    loadComponent: () =>
      ...
      data: { title: 'Cập nhật hóa đơn bán hàng', requiredPermission: 'Xem hóa đơn'},
      canActivate: [PermissionGuard],
  },
  {
    ...
    loadComponent: () =>
      ...
      data: { title: 'Thêm mới hóa đơn bán hàng',requiredPermission: 'Xem hóa đơn' },
      canActivate: [PermissionGuard],
  }
];
