...
@Component({
  selector: 'app-shipping-note-confirm-add',
  standalone: true,
  ...
  templateUrl: './shipping-note-confirm-add.component.html',
  providers: [MessageService],
  styleUrl: './shipping-note-confirm-add.component.scss'
})
export class ShippingNoteConfirmAddComponent implements OnInit{
  id: string | null = null;
  status: number = 0;
