...
export class PromotionAddComponent {
  ...
  onSelectItem(itemSelected: any, item: any) {
    ...
    this.data.promotionDetail[item].giaSauKM = itemSelected.giaBan-itemSelected.giaBan*(this.data.promotionDetail[item].tiLeKhuyenMai%100);
  ...
  initEdit(itemSelected: any, index: number) {
    ...
    this.getGiaBan_withByMaHangHoa(itemSelected.maHangHoa, (giaBan:number)=> {
      ...
      this.data.promotionDetail[index].giaSauKM=giaBan;
    })
  }
